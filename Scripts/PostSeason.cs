...
public class PostSeason : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CurrentDay.text = GameDirector.currentDate.year.ToString() + "łâ " + GameDirector.currentDate.month.ToString() + "żů " + GameDirector.currentDate.day.ToString() + "ŔĎ " + DataToString.DayOfWeekToString(GameDirector.currentDate.dayOfWeek);
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            {
                Texts[i].text = GameDirector.postSchedule[i].dates.month.ToString() + "/" + GameDirector.postSchedule[i].dates.day.ToString() + " " + (++k).ToString() + "Â÷Ŕü " + GameDirector.postSchedule[i].homeScore.ToString() + " : " + GameDirector.postSchedule[i].awayScore.ToString();
            ...
            {
                Texts[i].text = GameDirector.postSchedule[i].dates.month.ToString() + "/" + GameDirector.postSchedule[i].dates.day.ToString() + " " + (++k).ToString() + "Â÷Ŕü";
            }
